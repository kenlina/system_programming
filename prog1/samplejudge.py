...
def testcase0_1(io):
    try:
        ...
        assert compare("./BulletinBoard", f"{testpath}/testcase0-1-record"), "Record comparison failed."
        assert strcompare(serverlog, f"{testpath}/testcase0-1-server"), "Serverlog comparison failed."
        assert strcompare(clientlog, f"{testpath}/testcase0-1-client"), "Clientlog comparison failed."
